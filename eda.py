...
# plt.bar(state_sales["State"], state_sales["Sales"], color="skyblue")
...
# plt.figure(figsize=(6,4))
# plt.bar(profit_by_year['Year'], profit_by_year['Profit'],color='skyblue')
...
# plt.figure(figsize=(6,4))
# plt.bar(quantity_by_year['Year'], quantity_by_year['Quantity'], color='skyblue')
...
print(data.groupby('Category')['Sub-Category'].nunique()
      )
